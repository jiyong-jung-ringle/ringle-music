module Entities
  class PlaylistBasic < Grape::Entity
    ...
    expose :ownable do |playlist, options|
      ...
      when User.to_s
        UserBasic.represent playlist.ownable
      when Group.to_s
        GroupBasic.represent playlist.ownable, options.merge(current_user_groups: @current_user_groups)
      else
        nil
      end
    end
